...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sloppyan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '地球观察者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '需要填补的连接', // 网站地址
